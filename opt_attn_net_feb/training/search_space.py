...
def search_space(
    ...
    *,
    ...
    p = {"mol_hidden": trial.suggest_categorical("mol_hidden", [128, 256, 512]),
         ...
         "inst_hidden": trial.suggest_categorical("inst_hidden", [128, 256, 512]),
         "inst_layers": trial.suggest_int("inst_layers", 2, 5),
         ...
         "fusion_gate_temperature": trial.suggest_float("fusion_gate_temperature", 1.0, 2.5),
         "fusion_gate_prior_strength": trial.suggest_float("fusion_gate_prior_strength", 0.0, 0.25),
         "fusion_gate_prior_2d": 0.50,
         "fusion_gate_prior_3d_geom": 0.30,
         "fusion_gate_prior_3d_qm": 0.20,
         "fusion_gate_2d_max": trial.suggest_float("fusion_gate_2d_max", 0.58, 0.80),
         "fusion_gate_3d_min_total": trial.suggest_float("fusion_gate_3d_min_total", 0.15, 0.42),
...
def search_space_mt_2d3d_local(
    ...
    *,
    ...
    p: Dict[str, Any] = {
        ...
        "fusion_gate_temperature": trial.suggest_float("fusion_gate_temperature", 1.2, 2.5),
        "fusion_gate_prior_strength": trial.suggest_float("fusion_gate_prior_strength", 0.0, 0.25),
        "fusion_gate_prior_2d": 0.50,
        "fusion_gate_prior_3d_geom": 0.30,
        "fusion_gate_prior_3d_qm": 0.20,
        "fusion_gate_2d_max": trial.suggest_float("fusion_gate_2d_max", 0.58, 0.76),
        "fusion_gate_3d_min_total": trial.suggest_float("fusion_gate_3d_min_total", 0.20, 0.40),
